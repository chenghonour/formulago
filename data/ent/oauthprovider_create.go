...
func (_c *OauthProviderCreate) SetAppID(v string) *OauthProviderCreate {
	_c.mutation.SetAppID(v)
	return _c
}

// SetNillableAppID sets the "app_id" field if the given value is not nil.
func (_c *OauthProviderCreate) SetNillableAppID(v *string) *OauthProviderCreate {
	if v != nil {
		_c.SetAppID(*v)
	}
	return _c
...
func (_c *OauthProviderCreate) SetNillableAuthStyle(v *uint64) *OauthProviderCreate {
	if v != nil {
		_c.SetAuthStyle(*v)
	}
	return _c
...
func (_c *OauthProviderCreate) SetNillableInfoURL(v *string) *OauthProviderCreate {
	if v != nil {
		_c.SetInfoURL(*v)
	}
	return _c
