...
func (_u *RoleUpdate) SetOrderNo(v uint32) *RoleUpdate {
...
func (_u *RoleUpdate) SetNillableOrderNo(v *uint32) *RoleUpdate {
	if v != nil {
		_u.SetOrderNo(*v)
	}
	return _u
...
func (_u *RoleUpdate) AddOrderNo(v int32) *RoleUpdate {
...
// SetOrderNo sets the "order_no" field.
func (_u *RoleUpdateOne) SetOrderNo(v uint32) *RoleUpdateOne {
	_u.mutation.ResetOrderNo()
	_u.mutation.SetOrderNo(v)
	return _u
}
...
// SetNillableOrderNo sets the "order_no" field if the given value is not nil.
func (_u *RoleUpdateOne) SetNillableOrderNo(v *uint32) *RoleUpdateOne {
	if v != nil {
		_u.SetOrderNo(*v)
	}
	return _u
...
// AddOrderNo adds value to the "order_no" field.
func (_u *RoleUpdateOne) AddOrderNo(v int32) *RoleUpdateOne {
	_u.mutation.AddOrderNo(v)
	return _u
}
